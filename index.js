...
document.getElementById("mobile-home-link").addEventListener("click", mobileHome)
...
document.getElementById("mobile-about-link").addEventListener("click", mobileAboutAnimation)
...
document.getElementById("projects-link").addEventListener("click", projectAnimation)
document.getElementById("mobile-projects-link").addEventListener("click", mobileProjectAnimation)
